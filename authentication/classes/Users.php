...
<strong>Error !</strong> Câmpul Înregistrare utilizator nu trebuie să fie gol!</div>';
        return $msg;
...
<strong>Error !</strong> Introduceți numai caracterele numerice pentru câmpul numărului mobil!</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Parolați cel puțin 6 caractere!</div>';
        return $msg;
...
<strong>Error !</strong> E-mailul există deja, vă rugăm să încercați un alt e-mail ...!</div>';
  ...
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Success !</strong> Uau, v-ați înregistrat cu succes!</div>';
          return $msg;
      }else{
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<strong>Error !</strong> E-mailul există deja, vă rugăm să încercați un alt e-mail ...!</div>';
  ...
  <strong>Error !</strong> Adresa email invalida !</div>';
        ...
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Error !</strong> E-mailul nu a fost găsit, utilizați Înregistrați e-mailul sau parola, vă rugăm</div>';
          return $msg;
      }else{
        ...
        if ($chkActive == TRUE) {
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> Ne pare rău, contul dvs. este dezactivat, contactați administratorul!</div>';
            return $msg;
        }elseif ($logResult) {
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success !</strong> Sunteți autentificat cu succes!</div>');
          echo "<script>location.href='index.php';</script>";

        }else{
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> E-mailul sau parola nu s-au potrivit!</div>';
            return $msg;
        }
      ...
      $sql = "UPDATE tbl_users SET
       ...
       $result =   $stmt->execute();
        if ($result) {
          ...
          Session::set('msg', '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success !</strong> Contul de utilizator a fost dezactivat cu succes!</div>');
  ...
  <strong>Error !</strong> Parola nouă trebuie să aibă cel puțin 6 caractere!</div>';
         ...
         if ($oldPass == FALSE) {
           $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Error !</strong> Parola veche nu s-a potrivit!</div>';
             return $msg;
         }else{
          ...
          if ($result) {
            ...
            Session::set('msg', '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <strong>Success !</strong> Vești minunate, parola s-a schimbat cu succes!</div>');

          }else{
            $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <strong>Error !</strong> Parola nu s-a schimbat!</div>';
              return $msg;
          }
